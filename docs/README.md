...
|[/api/structure](https://www.ebi.ac.uk/interpro/api/structure)|List of counts|List of counts of structures in PDB (PDB is the only source of stucture data)|
