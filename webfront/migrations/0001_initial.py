    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(null=True, blank=True)),
                ('sequence_ga', models.FloatField(db_column='sequence_GA')),
                ('domain_ga', models.FloatField(db_column='domain_GA')),
                ('sequence_tc', models.FloatField(db_column='sequence_TC')),
                ('domain_tc', models.FloatField(db_column='domain_TC')),
                ('sequence_nc', models.FloatField(db_column='sequence_NC')),
                ('domain_nc', models.FloatField(db_column='domain_NC')),
                ('buildmethod', models.TextField(db_column='buildMethod')),
                ('model_length', models.IntegerField()),
                ('searchmethod', models.TextField(db_column='searchMethod')),
